...
sudo wget -q https://github.com/Nizwarax/vipz/releases/download/udp-zivpn_1.4.9/udp-zivpn-linux-amd64 -O /tmp/zivpn-bin-download
...
sudo mkdir -p /etc/zivpn
sudo wget https://raw.githubusercontent.com/Nizwarax/vipz/main/config.json -O /etc/zivpn/config.json
...
sudo wget -O /usr/local/bin/zivpn https://raw.githubusercontent.com/Nizwarax/vipz/main/zivpn-menu.sh
sudo chmod +x /usr/local/bin/zivpn

# Unduh skrip uninstall dan letakkan di path yang dapat diakses
sudo wget -O /usr/local/bin/uninstall.sh https://raw.githubusercontent.com/Nizwarax/vipz/main/uninstall.sh
sudo chmod +x /usr/local/bin/uninstall.sh

# Pasang skrip pembersihan otomatis dan jadwalkan
sudo wget -O /usr/local/bin/zivpn-cleanup.sh https://raw.githubusercontent.com/Nizwarax/vipz/main/zivpn-cleanup.sh
sudo chmod +x /usr/local/bin/zivpn-cleanup.sh
sudo wget -O /usr/local/bin/zivpn-autobackup.sh https://raw.githubusercontent.com/Nizwarax/vipz/main/zivpn-autobackup.sh
sudo chmod +x /usr/local/bin/zivpn-autobackup.sh
# Pasang skrip pemantauan server
sudo wget -O /usr/local/bin/zivpn-monitor.sh https://raw.githubusercontent.com/Nizwarax/vipz/main/zivpn-monitor.sh
...
sudo wget -O /etc/profile.d/zivpn-motd.sh https://raw.githubusercontent.com/Nizwarax/vipz/main/zivpn-motd.sh
...
sudo wget -O /usr/local/bin/zivpn_bot.py https://raw.githubusercontent.com/Nizwarax/vipz/main/zivpn_bot.py
...
sudo wget -O /etc/zivpn/qris.jpg https://raw.githubusercontent.com/Nizwarax/vipz/main/qris.jpg
