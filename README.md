...
### AMD64 (x86_64)
```bash
sudo wget -O /usr/local/bin/zi.sh https://raw.githubusercontent.com/Nizwarax/vipz/main/zi.sh && sudo chmod +x /usr/local/bin/zi.sh && sudo zi.sh
```

### ARM64
```bash
sudo wget -O /usr/local/bin/zi2.sh https://raw.githubusercontent.com/Nizwarax/vipz/main/zi2.sh && sudo chmod +x /usr/local/bin/zi2.sh && sudo zi2.sh
```
